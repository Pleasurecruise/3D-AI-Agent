...
public class SignalManager : MonoBehaviour
{
    ...
    public void GetAudioData(string _audioDataString)
    {
        if (_audioDataString.Contains("Head"))
        {
            ...
            m_getDataLength = 0;
            Debug.Log("Received data header: " + m_valuePartCount + "   " + m_audioLength);
        }
        else if (_audioDataString.Contains("Part"))
        {
            ...
            if (m_getDataLength == m_valuePartCount)
            {
                ...
                Debug.Log("Received length: " + _audioDataValue.Length + " Expected length: " + m_audioLength);
                ...
                Debug.Log("Already received length: " + data.Length);
                ...
                if (m_currentRecorderSign == "end")
                {
                    ...
                    */
                    ...
                    Debug.Log("Audio setup successful, set to unity." + m_audioClip.length + "  " + m_audioClip.name);
